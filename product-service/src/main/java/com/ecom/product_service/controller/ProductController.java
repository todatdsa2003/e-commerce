...
public class ProductController {
    ...
    @Operation(
        ...
        description = "Retrieve a paginated list of products with optional filtering by search keyword, status, category, or brand. Public access."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Retrieve detailed information about a specific product including its attributes and associated data. Public access."
    )
    @ApiResponses(value = {
